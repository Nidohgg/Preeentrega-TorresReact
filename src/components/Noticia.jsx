        ...
        <div className="container">
            <div className="row">
                <div className="col-md-6 d-flex align-items-center">
                    <p>El próximo año 2024 y los siguientes si no surgen retrasos nos traerán muchos juegos nuevos que mayormente serán exclusivos en consola aunque algunos saldrán tambien para PC.
                    Por ello te propongo esta lista repasando los más importantes y recomendados que debes seguir porque han resultado prometedores asegurando otro año con increibles juegazos tanto para playstation 5, la antigua playstation 4 y finalmente soporte con las gafas VR2 de realidad virtual.
